    ...
    <div className="relative mb-6">
      {mounted && (
        ...
        >
          ...
          {/* centered logo burst (short + snappy) */}
      ...
      <style jsx>{`
        ...
        /* Center logo: do a quick burst ONCE (not infinite) */
        .gt-center1 {
          animation: gtBurst1 0.28s steps(1, end) 1;
          mix-blend-mode: screen;
          opacity: 0.75;
          filter: grayscale(1) contrast(1.2);
        }
        .gt-center2 {
          animation: gtBurst2 0.28s steps(1, end) 1;
          mix-blend-mode: screen;
          opacity: 0.45;
          filter: grayscale(1) contrast(1.2);
        }
    ...
    <div className="h-full w-full">
      <svg viewBox="0 0 520 292" className="h-full w-full">
        ...
        <g>
          ...
          <text x="296" y="205" fontSize="12" fill="rgba(0,0,0,0.55)" fontFamily="ui-sans-serif, system-ui">AI likelihood</text>
          <text x="468" y="205" textAnchor="end" fontSize="12" fill="rgba(0,0,0,0.75)" fontFamily="ui-sans-serif, system-ui">41%</text>
          ...
          <text x="296" y="245" fontSize="12" fill="rgba(16,185,129,0.90)" fontFamily="ui-sans-serif, system-ui">Human</text>
          <text x="468" y="245" textAnchor="end" fontSize="12" fill="rgba(239,68,68,0.90)" fontFamily="ui-sans-serif, system-ui">AI</text>
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="h-full w-full">
      <svg viewBox="0 0 520 292" className="h-full w-full">
        ...
        <text x="56" y="226" fontSize="12" fill="rgba(0,0,0,0.55)" fontFamily="ui-sans-serif, system-ui">AI likelihood</text>
        <text x="464" y="226" textAnchor="end" fontSize="12" fill="rgba(0,0,0,0.75)" fontFamily="ui-sans-serif, system-ui">72%</text>
        ...
        <text x="56" y="262" fontSize="12" fill="rgba(16,185,129,0.90)" fontFamily="ui-sans-serif, system-ui">Human</text>
        <text x="464" y="262" textAnchor="end" fontSize="12" fill="rgba(239,68,68,0.90)" fontFamily="ui-sans-serif, system-ui">AI</text>
      </svg>
    </div>
  );
}

function TyperIllustration() { return ( <div className="relative h-full w-full"> <svg viewBox="0 0 520 292" className="h-full w-full"> <rect x="0" y="0" width="520" height="292" rx="26" fill="rgba(0,0,0,0.02)" /> <g> <rect x="28" y="34" width="230" height="224" rx="22" fill="rgba(0,0,0,0.04)" stroke="rgba(0,0,0,0.12)" /> <rect x="46" y="52" width="194" height="30" rx="12" fill="rgba(255,255,255,0.55)" stroke="rgba(0,0,0,0.10)" /> <circle cx="64" cy="67" r="6" fill="rgba(239,68,68,0.55)" /> <circle cx="82" cy="67" r="6" fill="rgba(234,179,8,0.55)" /> <circle cx="100" cy="67" r="6" fill="rgba(16,185,129,0.55)" /> <text x="124" y="72" fontSize="12" fill="rgba(0,0,0,0.75)" fontFamily="ui-sans-serif, system-ui"> Ghost Typer </text> <rect x="46" y="94" width="194" height="54" rx="14" fill="rgba(255,255,255,0.45)" stroke="rgba(0,0,0,0.10)" /> <rect x="60" y="108" width="120" height="10" rx="5" fill="rgba(0,0,0,0.10)" /> <rect x="60" y="128" width="162" height="10" rx="5" fill="rgba(0,0,0,0.10)" /> <rect x="46" y="158" width="194" height="70" rx="14" fill="rgba(255,255,255,0.45)" stroke="rgba(0,0,0,0.10)" /> <rect x="60" y="172" width="150" height="10" rx="5" fill="rgba(0,0,0,0.10)" /> <rect x="60" y="192" width="132" height="10" rx="5" fill="rgba(0,0,0,0.10)" /> <rect x="60" y="212" width="164" height="10" rx="5" fill="rgba(0,0,0,0.10)" /> </g> <g> <rect x="276" y="34" width="216" height="224" rx="22" fill="rgba(255,255,255,0.55)" stroke="rgba(0,0,0,0.12)" /> <rect x="294" y="52" width="180" height="26" rx="12" fill="rgba(0,0,0,0.05)" stroke="rgba(0,0,0,0.10)" /> <rect x="304" y="60" width="40" height="10" rx="5" fill="rgba(0,0,0,0.10)" /> <rect x="350" y="60" width="28" height="10" rx="5" fill="rgba(0,0,0,0.10)" /> <rect x="384" y="60" width="28" height="10" rx="5" fill="rgba(0,0,0,0.10)" /> <rect x="418" y="60" width="46" height="10" rx="5" fill="rgba(0,0,0,0.10)" /> <rect x="294" y="92" width="180" height="10" rx="5" fill="rgba(0,0,0,0.08)" /> <rect x="294" y="112" width="168" height="10" rx="5" fill="rgba(0,0,0,0.08)" /> <rect x="294" y="132" width="174" height="10" rx="5" fill="rgba(0,0,0,0.08)" /> <rect x="294" y="152" width="156" height="12" rx="6" fill="rgba(0,0,0,0.06)" /> <rect className="gt-type" x="294" y="152" width="0" height="12" rx="6" fill="rgba(0,0,0,0.18)" /> <rect className="gt-caret" x="294" y="150" width="2" height="16" fill="rgba(0,0,0,0.70)" /> <rect x="294" y="176" width="142" height="10" rx="5" fill="rgba(0,0,0,0.08)" /> <rect x="294" y="196" width="168" height="10" rx="5" fill="rgba(0,0,0,0.08)" /> </g> </svg> </div> ); } 
