...
function GoogleIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" className="h-5 w-5">
      <path fill="#EA4335" d="M24 9.5c3.2 0 6.1 1.1 8.3 3.2l6.2-6.2C34.6 2.3 29.6 0 24 0 14.6 0 6.5 5.5 2.5 13.4l7.2 5.6C11.6 13.3 17.2 9.5 24 9.5z"/>
      <path fill="#4285F4" d="M46.5 24.5c0-1.7-.1-2.9-.4-4.2H24v8h12.7c-.3 2-1.7 5-4.8 7l7.4 5.8c4.3-4 6.8-9.8 6.8-16.6z"/>
      <path fill="#FBBC05" d="M9.7 28.9c-1-2.9-1-6 0-8.9l-7.2-5.6C.9 17.5 0 20.6 0 24c0 3.4.9 6.5 2.5 9.6l7.2-5.6z"/>
      <path fill="#34A853" d="M24 48c6.5 0 12-2.1 16-5.8l-7.4-5.8c-2 1.4-4.7 2.4-8.6 2.4-6.8 0-12.4-3.8-14.4-9.5l-7.2 5.6C6.5 42.5 14.6 48 24 48z"/>
    </svg>
  );
}
