...
export default function DetectImageClient() {
      ...
      <main className="px-10 py-8">
        <div className="mb-8 flex items-start justify-between gap-6">
          <div>
            ...
            <div className="mt-1 text-sm text-white/60">Upload an image to analyze. Viewing is public; running requires login.</div>
          </div>
        ...
        {saveMsg && (
          <div className="mb-4 rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-sm text-white/80">{saveMsg}</div>
        )}
